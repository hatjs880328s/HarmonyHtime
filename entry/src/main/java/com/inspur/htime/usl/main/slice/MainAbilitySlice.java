package com.inspur.htime.usl.main.slice;
...
import com.inspur.htime.bll.NotificationCenter.NotificationCenter;
import com.inspur.htime.bll.NotificationCenter.NotificationObserver;
                ...
                getUITaskDispatcher().asyncDispatch(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Operation oper = new Intent.OperationBuilder()
                                ...
                                .withAbilityName("com.inspur.htime.usl.main.Login")
                                .build();
